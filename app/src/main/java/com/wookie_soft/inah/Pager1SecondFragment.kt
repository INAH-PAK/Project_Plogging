...
class Pager1SecondFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        items.add(ItemTab1("D-1","2022년 4월 26일", "오후 8시"," 길동이랑 만나기"))
        items.add(ItemTab1("D-3","2022년 4월 28일", "오전 7시"," 춘향이랑 아침산책"))
        items.add(ItemTab1("D-5","2022년 4월 30일", "오후 5시"," 가족들과 저녁후 산책"))
