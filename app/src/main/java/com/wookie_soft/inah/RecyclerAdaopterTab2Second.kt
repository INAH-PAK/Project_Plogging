...
class RecyclerAdaopterTab2Second constructor(val context: Context, var items: MutableList<ClipData.Item>): RecyclerView.Adapter<RecyclerAdaopterTab2Second.VH>(){
